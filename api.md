...
- <a href="https://pkg.go.dev/github.com/et0and/address-go">address</a>.<a href="https://pkg.go.dev/github.com/et0and/address-go#GetAPIInfoResponse">GetAPIInfoResponse</a>

Methods:

- <code title="get /">client.<a href="https://pkg.go.dev/github.com/et0and/address-go#AddressService.GetAPIInfo">GetAPIInfo</a>(ctx <a href="https://pkg.go.dev/context">context</a>.<a href="https://pkg.go.dev/context#Context">Context</a>) (\*<a href="https://pkg.go.dev/github.com/et0and/address-go">address</a>.<a href="https://pkg.go.dev/github.com/et0and/address-go#GetAPIInfoResponse">GetAPIInfoResponse</a>, <a href="https://pkg.go.dev/builtin#error">error</a>)</code>
