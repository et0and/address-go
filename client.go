...
// interacting with the address API. You should not instantiate this client
...
// environment (ADDRESS_API_KEY, ADDRESS_BASE_URL). The option passed in as
...
func NewClient(opts ...option.RequestOption) (r Client) {
	...
	r.Challenge = NewChallengeService(opts...)
	r.RequestKey = NewRequestKeyService(opts...)
	r.Addresses = NewAddressService(opts...)
	r.Search = NewSearchService(opts...)
	r.Reverse = NewReverseService(opts...)
	r.Meta = NewMetaService(opts...)
